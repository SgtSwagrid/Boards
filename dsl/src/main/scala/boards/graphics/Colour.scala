 ...
 *
  ...
  */
case class Colour (hex: Int, name: String = "") derives Codec.AsObject:
...
object Colour:
  ...
  /** 0x000000 */ val Black  : Colour = Colour.hex(0x000000, colourStr(0))
  /** 0xFFFFFF */ val White  : Colour = Colour.hex(0xFFFFFF, colourStr(7))
  /** 0xFF0000 */ val Red    : Colour = Colour.hex(0xFF0000, colourStr(1))
  /** 0x00FF00 */ val Green  : Colour = Colour.hex(0x00FF00, colourStr(2))
  /** 0x0000FF */ val Blue   : Colour = Colour.hex(0x0000FF, colourStr(4))
  /** 0xFFFF00 */ val Yellow : Colour = Colour.hex(0xFFFF00, colourStr(3))
  /** 0xFF00FF */ val Magenta: Colour = Colour.hex(0xFF00FF, colourStr(5))
  /** 0x00FFFF */ val Cyan   : Colour = Colour.hex(0x00FFFF, colourStr(6))
  
  /** The colours of a chess board. */
  object Chess:
    /** 0xD18B47 */ val Dark : Colour = Colour.hex(0xD18B47)
    /** 0xFFCE9E */ val Light: Colour = Colour.hex(0xFFCE9E)
